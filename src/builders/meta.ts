...
export const buildMeta = (meta: Meta) => {
  const footerList = [
    meta.userAgent,
    meta.ipUrl ? html("a", "IP", { href: meta.ipUrl, target: "_blank" }) : null,
  ...
  const colour = "#a0a0a0";
  const style = { fontSize: "11px", borderTop: `1px dotted ${colour}`, color: colour, paddingTop: "6px", marginTop: "6px" };
